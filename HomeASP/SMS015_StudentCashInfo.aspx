                            ...
                            <div style="float: left">
                                <table id="cashTbl" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                            <asp:Label ID="errId" CssClass="errmsg-format" runat="server"></asp:Label></td>
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                            <asp:Label ID="Label3" CssClass="Lab-format" runat="server"></asp:Label></td>
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                            <asp:Label ID="Label6" CssClass="Lab-format" runat="server"></asp:Label></td>
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                    ...
                                    <tr >
                                     ...
                                     <tr class="spaceUnder">
                                        ...
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                             <asp:Label ID="errGrade" CssClass="errmsg-format" runat="server"></asp:Label></td>
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td>
                                            <asp:Label ID="Label7" CssClass="Lab-format" runat="server"></asp:Label></td>
                                        <td><span style="margin-left: 2em"></span></td>
                                        <td><asp:Label ID="errYear" CssClass="errmsg-format" runat="server"></asp:Label></td>
                                    </tr>
                                </table>
                            </div>
                            <div>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Panel ID="payPannel" runat="server" CssClass="pa-Format" GroupingText="Payment">
                                                ...
                                                <br />
                                                <asp:Label ID="Label8" CssClass="Lab-format" Visible="false" runat="server">Cash Type</asp:Label>
                                                <span style="margin-left: 1em; color: black" /><span style="margin-left: 1em" />
                                                <asp:Label ID="Label9" runat="server" CssClass="errmsg-format"></asp:Label>
                                                <br />
                                                <br />
                                                ...
                                                <br />
                                                <asp:Label ID="Label10" CssClass="Lab-format" Visible="false" runat="server">Account No.</asp:Label>
                                                <span style="margin-left: 2em"></span>
                                                <asp:Label ID="errAccNo" runat="server" CssClass="errmsg-format"></asp:Label>
                                                <br />
                                                <br />
                                                ...
                                                <br />
                                                <asp:Label ID="Label11" CssClass="Lab-format" Visible="false" runat="server">Amount </asp:Label>
                                                <span style="margin-left: 2em"></span>
                                                <asp:Label ID="errAmt" runat="server" CssClass="errmsg-format"></asp:Label>
                                                <br />
